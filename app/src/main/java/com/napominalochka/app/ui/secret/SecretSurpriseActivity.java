...
public class SecretSurpriseActivity extends AppCompatActivity {
    ...
    private void showUnlockedContent() {
        ...
        // Получаем случайный ASCII-арт
        String randomHeart = AppTexts.ASCII_HEARTS[(int)(Math.random() * AppTexts.ASCII_HEARTS.length)];
        
        String message = "💖 ОСОБОЕ ПОСЛАНИЕ ДЛЯ ТЕБЯ 💖\n\n" +
        ...
        secretContentText.setText(message);
